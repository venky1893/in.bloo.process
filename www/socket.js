cordova.define("in.ebuilders.process.Socket", function(require, exports, module) { var exec = require('cordova/exec');
...
function Socket(){
    ...
    this.pluginRef = 'PrimeProcessSocket';                              // *** Plugin reference for Cordova.exec calls
}
...
Socket.prototype.setMachineName = function (successCallback, errorCallback, machineName) {
    'use strict';
    exec(successCallback, errorCallback, this.pluginRef, 'setMachineName', [machineName]);
};

Socket.prototype.setStartingCavity = function (successCallback, errorCallback, startingCavity) {
    'use strict';
    exec(successCallback, errorCallback, this.pluginRef, 'setStartingCavity', [startingCavity]);
};
